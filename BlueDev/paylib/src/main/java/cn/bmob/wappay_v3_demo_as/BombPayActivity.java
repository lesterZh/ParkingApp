...
public class BombPayActivity extends Activity implements RadioGroup.OnCheckedChangeListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        BP.init("ecb54b452ae84a52f7c45894cabef9af");
        ...
        try {
            ...
            try {
                ...
                try {
                    ...
                    Toast.makeText(BombPayActivity.this,
        ...
        if (requestCode == REQUESTPERMISSION) {
            if (permissions[0].equals(Manifest.permission.WRITE_EXTERNAL_STORAGE)) {
                if (grantResults[0] == PackageManager.PERMISSION_GRANTED) {
                    ...
                    //提示没有权限，安装不了
                    Toast.makeText(BombPayActivity.this,"您拒绝了权限，这样无法安装支付插件",Toast.LENGTH_LONG).show();
                }
            }
        }
    }
    ...
    void pay(final boolean alipayOrWechatPay) {
        if (alipayOrWechatPay) {
            if (!checkPackageInstalled("com.eg.android.AlipayGphone",
                ...
                Toast.makeText(BombPayActivity.this, "请安装支付宝客户端", Toast.LENGTH_SHORT)
                        .show();
                return;
            }
        } else {
...
//                    installBmobPayPlugin("bp.db");
                ...
                Toast.makeText(BombPayActivity.this, "请安装微信客户端", Toast.LENGTH_SHORT).show();
                return;
            }
        }
        ...
        BP.pay(name, getBody(), getPrice(), alipayOrWechatPay, new PListener() {
            ...
            @Override
            public void unknow() {
                Toast.makeText(BombPayActivity.this, "支付结果未知,请稍后手动查询", Toast.LENGTH_SHORT)
                        .show();
            ...
            @Override
            public void succeed() {
                Toast.makeText(BombPayActivity.this, "支付成功!", Toast.LENGTH_SHORT).show();
...
//                    installBmobPayPlugin("bp.db");
                    ...
                    Toast.makeText(BombPayActivity.this, "支付中断!", Toast.LENGTH_SHORT)
                            .show();
                }
    ...
    void query() {
        ...
        BP.query(orderId, new QListener() {
            ...
            public void succeed(String status) {
                Toast.makeText(BombPayActivity.this, "查询成功!该订单状态为 : " + status,
                        Toast.LENGTH_SHORT).show();
            ...
            @Override
            public void fail(int code, String reason) {
                Toast.makeText(BombPayActivity.this, "查询失败", Toast.LENGTH_SHORT).show();
